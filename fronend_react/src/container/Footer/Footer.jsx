        ...
        <>
            ...
            <div className='app__footer-cards'>
                ...
                <div className='app__footer-card'>
                    ...
                    <a href='mailto:halisasaipulla@gmail.com' className='p-text'>
            ...
            <div className='app__footer-form app__flex'>
                <div className='app__flex'>
                    <input 
                        className="p-text" type="text" placeholder="Your Name" 
                        name="username" value={username} onChange={handleChangeInput} />
                </div>
                <div className='app__flex'>
                    <input 
                        className="p-text" type="email" placeholder="Your Email" 
